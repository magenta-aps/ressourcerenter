...
class StatistikTestCase(TestCase):
    ...
    def setUp(self):
        ...
        afgiftsperiode = Afgiftsperiode.objects.get(
    ...
    def test_fiskeart_eksport_explicit_indberetningstype(self):
        ...
        self.assertEqual(resultat[0], {'År': '2022', 'Kvartal': '1. kvartal', 'Indberetningstype': 'Eksport', 'Fiskeart (eksport)': 'Hellefisk', 'Levende vægt tons': Decimal('0.22')})
        ...
        self.assertEqual(1, len(resultat))
        self.assertEqual(resultat[0], {'År': '2022', 'Kvartal': '1. kvartal', 'Indberetningstype': 'Eksport', 'Fiskeart (eksport)': 'Hellefisk', 'Fiskeart (indhandling)': '', 'Levende vægt tons': Decimal('0.22')})
    ...
    def test_fiskeart_indhandling_explicit_indberetningstype(self):
        ...
        self.assertEqual(1, len(resultat))
        self.assertEqual(resultat[0], {'År': '2022', 'Kvartal': '1. kvartal', 'Indberetningstype': 'Indhandling', 'Fiskeart (indhandling)': 'Hellefisk', 'Levende vægt tons': Decimal('2.0')})
        ...
        self.assertEqual(1, len(resultat))
        self.assertEqual(resultat[0], {'År': '2022', 'Kvartal': '1. kvartal', 'Indberetningstype': 'Indhandling', 'Fiskeart (eksport)': '', 'Fiskeart (indhandling)': 'Hellefisk', 'Levende vægt tons': Decimal('2.0')})
        ...
        resultat = self.get_form_result(
            indberetningstype='Indhandling',
            fiskeart_indhandling=FiskeArt.objects.get(navn_dk='Hellefisk').uuid,
            produkttype_eksport=ProduktType.objects.get(navn_dk='Hellefisk - Hel fisk').uuid,
        )
        self.assertEqual(1, len(resultat))
        self.assertEqual(resultat[0], {'År': '2022', 'Kvartal': '1. kvartal', 'Indberetningstype': 'Indhandling', 'Fiskeart (indhandling)': 'Hellefisk', 'Produkttype (eksport)': '', 'Levende vægt tons': Decimal('2.0')})
    ...
    def test_fiskeart_eksport_unset_indberetningstype(self):
        ...
        self.assertEqual(resultat[0], {'År': '2022', 'Kvartal': '1. kvartal', 'Fiskeart (eksport)': '', 'Levende vægt tons': Decimal('2.0')})  # indhandling
        self.assertEqual(resultat[1], {'År': '2022', 'Kvartal': '1. kvartal', 'Fiskeart (eksport)': 'Hellefisk', 'Levende vægt tons': Decimal('0.22')})  # eksport
    ...
    def test_fiskeart_indhandling_unset_indberetningstype(self):
        ...
        self.assertEqual(2, len(resultat))
        self.assertEqual(resultat[0], {'År': '2022', 'Kvartal': '1. kvartal', 'Fiskeart (indhandling)': '', 'Levende vægt tons': Decimal('0.22')})  # eksport
        self.assertEqual(resultat[1], {'År': '2022', 'Kvartal': '1. kvartal', 'Fiskeart (indhandling)': 'Hellefisk', 'Levende vægt tons': Decimal('2.0')})  # indhandling
    ...
    def test_fiskeart_eksport_indhandling_unset_indberetningstype(self):
        ...
        self.assertEqual(2, len(resultat))
        self.assertEqual(resultat[0], {'År': '2022', 'Kvartal': '1. kvartal', 'Fiskeart (eksport)': '', 'Fiskeart (indhandling)': 'Hellefisk', 'Levende vægt tons': Decimal('2.0')})  # indhandling
        self.assertEqual(resultat[1], {'År': '2022', 'Kvartal': '1. kvartal', 'Fiskeart (eksport)': 'Hellefisk', 'Fiskeart (indhandling)': '', 'Levende vægt tons': Decimal('0.22')})  # eksport
