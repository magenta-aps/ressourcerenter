...
class FakturaTestCase(TransactionTestCase):
    ...
    def test_create_fakturaer(self):
        ...
        faktura1a = Faktura.from_linje(linje1a, self.user, betalingsdato)
        ...
        faktura1b = Faktura.from_linje(linje1b, self.user, betalingsdato)
        ...
        faktura1c = Faktura.from_linje(linje1c, self.user, betalingsdato)
        ...
        faktura1d = Faktura.from_linje(linje1d, self.user, betalingsdato)
        ...
        faktura2a = Faktura.from_linje(linje2a, self.user, betalingsdato)
        ...
        faktura2b = Faktura.from_linje(linje2b, self.user, betalingsdato)
        ...
        faktura2c = Faktura.from_linje(linje2c, self.user, betalingsdato)
        ...
        faktura2d = Faktura.from_linje(linje2d, self.user, betalingsdato)
        ...
        faktura2e = Faktura.from_linje(linje2e, self.user, betalingsdato)
