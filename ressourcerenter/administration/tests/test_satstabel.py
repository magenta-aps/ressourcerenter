...
class PrismeTestCase(TestCase):
    ...
    def test_satstabel_update(self):
        ...
        r = self.client.get(reverse('administration:afgiftsperiode-satstabel', kwargs={'pk': afgiftsperiode.pk}))
        ...
        r = self.client.post(
            reverse('administration:afgiftsperiode-satstabel', kwargs={'pk': afgiftsperiode.pk}),
            data
        )
