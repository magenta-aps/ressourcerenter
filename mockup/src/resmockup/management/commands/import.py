...
from resmockup.models import FormularFelt, BeregningsModelEksempel, \
    BeregningsModelPrototype, Afgiftstabel, Afgiftsperiode, Indberetning, \
    BeregnetIndberetning, Indberetter, FiskeArt, Kategori, SummeretBeregnetIndberetning
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        summeretberegnetindberetning1, created = SummeretBeregnetIndberetning.objects.get_or_create(
            justering=False,
